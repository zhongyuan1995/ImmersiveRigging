...
public:
	...
	void stop_animation();
	///
	void start_record_anim() {recording = true;std::cout << "recording to list" << std::endl;}
	///
	...
	///
	void set_skel_origin_ori_translation(const Vec3 rot_axis, float angle_degrees, Vec3 translation) {
		// rotate first
